...
public final class FuzzyKmeansRunner extends AbstractJob {
  ...
  private FuzzyKmeansRunner() {
  }
  
  public static void run() throws Exception {
//      log.info("Running with only user-supplied arguments");
//      ToolRunner.run(new Configuration(), new FuzzyKmeansRunner(), args);
      log.info("Running with default arguments");
      Path output = new Path("output");
      Configuration conf = new Configuration();
      HadoopUtil.delete(conf, output);
      _run(conf, new Path("testdata"), output, new EuclideanDistanceMeasure(), 80, 55, 10, 2.0f, 0.5);
  }
  ...
  public int run(String[] args) throws Exception {
    ...
    _run(getConf(), input, output, measure, t1, t2, maxIterations, fuzziness, convergenceDelta);
    return 0;
  }
   ...
   */
  public static void _run(Configuration conf, Path input, Path output, DistanceMeasure measure, double t1, double t2,
